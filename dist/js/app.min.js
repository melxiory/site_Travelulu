...
/***/ "./node_modules/@uvarov.frontend/vanilla-calendar/build/vanilla-calendar.min.mjs":
/*!***************************************************************************************!*\
  !*** ./node_modules/@uvarov.frontend/vanilla-calendar/build/vanilla-calendar.min.mjs ***!
  \***************************************************************************************/
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\nfunction initSlowScroll() {\n  var links = document.querySelectorAll('a[href^=\"#\"]'); // все ссылки, с атрибутом href, начинающимся с \"#\"\n  links.forEach(function (item) {\n    return item.addEventListener('click', function (e) {\n      e.preventDefault();\n      var id = item.getAttribute('href').slice(1);\n      document.getElementById(id).scrollIntoView({\n        behavior: 'smooth',\n        block: 'start'\n      });\n    });\n  });\n}\n/* harmony default export */ __webpack_exports__[\"default\"] = (initSlowScroll);\n\n//# sourceURL=webpack://gulp-2022/./src/js/modules/slowScroll.js?");
